...
class Asteroid:
    def __init__(self, x, y, t, display_width, display_height, gameDisplay, color):
        self.x = x
        self.y = y
    ...
    def update_asteroid(self):
        ...
        for v in range(len(self.vertices)):
            ...
            pygame.draw.line(self.gameDisplay, self.color, (self.x + this_v[0] * math.cos(this_v[1] * math.pi / 180),
